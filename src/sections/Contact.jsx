...
const Contact = () => {
  ...
  const isFormCardInView = useInView(formCardRef, { amount: 0.3 });
  ...
  return (
    <section id="contact" ref={sectionRef} className="relative py-20 md:py-32 overflow-hidden">
      ...
      <motion.div 
        ...
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-pink-500/10 rounded-full blur-3xl -z-10"
      ></motion.div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-32">
        ...
        <div ref={titleRef} className="text-center mb-16">
          ...
          <motion.div 
            ...
            className="h-1 bg-gradient-to-r from-cyan-400 to-purple-500 mx-auto"
          />
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={isTitleInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <motion.div 
            ...
            animate={isInfoCardInView ? { opacity: 1, x: 0 } : { opacity: 0, x: -50 }}
            transition={{ duration: 0.7 }}
            className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 md:p-10 border border-gray-700 
                     hover:border-cyan-400/50 transition-all duration-300 h-full"
          >
            <motion.h3
              initial={{ opacity: 0, y: 10 }}
              animate={isInfoCardInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 10 }}
            ...
            <div className="space-y-8">
              {contactInfo.map((info, index) => (
                <motion.div
                  ...
                  animate={isInfoCardInView ? 
                    { opacity: 1, x: 0, transition: { duration: 0.5, delay: 0.2 + index * 0.1 } } : 
                    { opacity: 0, x: -20 }
                  }
                  className="group"
                >
              ...
              <div className="grid grid-cols-4 gap-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    initial={{ opacity: 0, scale: 0.8 }}
                    animate={isInfoCardInView ? 
                      { opacity: 1, scale: 1, transition: { delay: 0.6 + index * 0.1 } } : 
                      { opacity: 0, scale: 0.8 }
                    }
          ...
          <motion.div
            ref={formCardRef}
            initial={{ opacity: 0, x: 50 }}
            animate={isFormCardInView ? { opacity: 1, x: 0 } : { opacity: 0, x: 50 }}
            transition={{ duration: 0.7 }}
          >
            <form onSubmit={handleSubmit} className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 md:p-10 border border-gray-700 
              ...
              <motion.h3
                initial={{ opacity: 0, y: 10 }}
                animate={isFormCardInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 10 }}
                transition={{ duration: 0.5, delay: 0.1 }}
              ...
              <div className="space-y-6">
                ...
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={isFormCardInView ? 
                    { opacity: 1, y: 0, transition: { duration: 0.5, delay: 0.4 } } : 
                    { opacity: 0, y: 20 }
                  }
                >
